...
Doctrine:
- Build an industrial base quickly, then transition to sustained military output.
...
- Start concentrated Fighter production once core industry is established.

Commander profile cues:
- Methodical, patient, systems-oriented.
- Formal, precise diplomatic language.
- Values long-term production curves and attrition advantage.
